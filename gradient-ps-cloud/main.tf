...
module "gradient_processing" {
  ...
  domain                                 = var.domain
  google_drive_integration_client_id     = var.google_drive_integration_client_id
  google_drive_integration_client_secret = var.google_drive_integration_client_secret
  google_drive_integration_redirect_uri  = var.google_drive_integration_redirect_uri
  ...
  image_cache_list = length(var.image_cache_list) != 0 ? var.image_cache_list : [
    ...
    "paperspace/fastai:2.0-fastbook-2022-04-04",
